...
private:
    ...
    typedef ElementProperty<unsigned int, Surface_mesh::Vertex>  IndexVertexProperty;
...
void EigenContractionHelper::updateVertexIndexes(){
    ...
    vindex = mesh->vertex_property<unsigned int>("v:index",0);
    unsigned int curr_vidx = 0;
